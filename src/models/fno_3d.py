...
class FNO3d(nn.Module):
    def __init__(self, modes1, modes2, modes3, width, debug=False):
        ...
        self.p = nn.Linear(6, self.width)# input channel is 12: the solution of the first 10 timesteps + 3 locations (u(1, x, y), ..., u(10, x, y),  x, y, t)
